-- Migration 001_initial — full v1 schema.
--
-- Identical DDL to db/schema.sql. Applied to existing DBs that predate the
-- migration mechanism, or as the baseline migration. All statements use
