...
- [ ] step_1_scope_and_naming.md — что копируем (только код), как называется новый репо, 05_refind не трогаем, обновление `05_refind/CLAUDE.md`

### Шаг 2: Создание нового репозитория
- [ ] step_2_create_new_repo.md — git init, копирование кода из 05_refind, импорты, load_dotenv, проверка что ручные прогоны работают из нового места
